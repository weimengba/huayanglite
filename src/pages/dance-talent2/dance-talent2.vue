      ...
      <scroll-view class="list-wrap" 
        ...
        <div class="grade1" @click="viewDetail(firstData.id)">
          ...
          <div class="content">
            <div class="picture-wrap">
              <image class="picture" mode="aspectFill" lazy-load="lazyload" :src="firstData.thumb"></image>
            </div>
            <div class="info-wrap">
        ...
        <div class="list">
          ...
          <div v-for="(item,index) in rankList" v-if="index>0" class="grade-item" :key="index" @click="viewDetail(item.id)">
            ...
            <div class="content">
              <div class="picture-wrap">
                <image class="picture" mode="aspectFill" lazy-load="lazyload" :src="item.thumb"></image>
              </div>
              <div class="info-wrap">
  ...
  export default {
    data() {
      return {
        ...
        tip: [
          '舞蹈达人争霸赛，旨在选出，最有影响力最受欢的舞蹈老师，为舞蹈界添花增叶，为各位老师歌功扬名。',
          '排行榜:榜单时间为倒计时7天，红花数仅统计活动期间，最终以榜单红花数确定最终排名。',
          '评选活动已经结束',
          '',
        ],
        
        banner: this.imgUrl + 'dt_logo3@2x.png',
    ...
    onShareAppMessage() {
      return {
        path: `/pages/dance-talent2/main?auid=${this.auid}`,
